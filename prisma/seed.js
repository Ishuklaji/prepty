...
// ── CHANGE THIS ───────────────────────────────────────────────────────────────
const BOOKING_ID = "3aff9388-94f4-49de-af22-6567a3839e27";
// ─────────────────────────────────────────────────────────────────────────────

const feedback = {
  summary:
    "Ish demonstrated a solid understanding of React fundamentals and component architecture. He approached problems methodically and showed good instincts around state management. With some refinement in system design and async patterns, he's well on track for a mid-level frontend role.",
  technical:
  ...
  sessionRating: 4,
  sessionComment:
    "Great session — Ish was engaged and receptive to feedback. Would be happy to interview him again after he's done more system design prep.",
};
