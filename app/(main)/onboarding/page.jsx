          ...
          <div className="grid grid-cols-2 gap-4 w-full">
            {ONBOARDING_ROLES.map((r) => (
              <button
                ...
                className="text-left rounded-2xl p-8 border border-white/10 bg-[#0f0f11] cursor-pointer hover:border-amber-400/20 hover:-translate-y-0.5 transition-all duration-300"
              >
            ...
            {role === "INTERVIEWER" && (
              <div className="bg-[#0f0f11] border border-white/10 rounded-2xl p-8 flex flex-col gap-6">
                ...
                <Textarea
                  rows={4}
                  maxLength={300}
                  placeholder="Tell interviewees about your background, what are you specialized in, and what they can expect from a session with you."
                  value={form.bio}
                  onChange={(e) =>
