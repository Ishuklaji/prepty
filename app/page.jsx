      ...
      <section className="relative min-h-screen grid grid-cols-1 lg:grid-cols-5 px-4 sm:px-8 pt-28 sm:pt-32 pb-20 overflow-hidden">
        ...
        <div className="col-span-full lg:col-span-3 flex flex-col items-center justify-center text-center lg:-rotate-2 ">
          ...
          <p className="relative text-sm sm:text-base md:text-lg text-stone-400 max-w-xl mt-6 leading-relaxed">
            Book 1:1 mock interviews with expert engineers from top companies.
        ...
        <div className="grid grid-cols-12 gap-4">
          ...
          <div className="col-span-12 md:col-span-5">
            <BentoCard
              ...
              description="Subscribe for monthly credits. Book sessions. Interviewers earn and withdraw any time."
            >
          ...
          <div className="col-span-12 md:col-span-4">
            <BentoCard
              ...
              description="Message your interviewer before and after the call. Share resources, prep notes, and follow-ups in one thread."
            />
          </div>
          ...
          <div className="col-span-12 md:col-span-6">
            <BentoCard
              ...
              description="Post-interview analysis by Gemini with actionable insights."
            >
              <MockUI rows={5} />
            </BentoCard>
          </div>
          ...
          <div className="col-span-12 md:col-span-6">
            <BentoCard
              ...
              description="Interviewers set availability once. Interviewees pick from open slots and confirm with one click — no back-and-forth needed."
            >
              <div className="flex flex-wrap gap-2 mt-5">
                {SLOTS.map((s) => (
                  <span
